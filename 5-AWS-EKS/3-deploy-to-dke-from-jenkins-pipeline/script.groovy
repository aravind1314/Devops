...
def deploy() {
    withKubeConfig([credentialsId:'dke-cred',serverUrl:'https://65c8478a-d08a-4890-8128-a38b1b235820.k8s.ondigitalocean.com'])
    {
...
def pushVersion() {
    ...
    withCredentials([usernamePassword(credentialsId:'gitlab-cred',usernameVariable:'usr',passwordVariable:'pwd')]) {
        sh "git remote set-url origin https://${usr}:${pwd}@gitlab.com/aravind1314/deploy-to-dke.git"
